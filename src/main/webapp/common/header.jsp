...
<head>
    ...
    <base href="<%=basePath%>">
    <script type="text/javascript" src="<%=request.getContextPath() %>/static/h-ui/js/jquery-2.1.4.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath() %>/common/event.js"></script>
        ...
        <dl id="menu-member">
            ...
            <dd style="display: block;">
                <ul>
                    ...
                    <li><a href="<%=request.getContextPath() %>/user/userList.do" title="会员列表">会员列表</a></li>
                    </shiro:hasRole>
                    <li><a href="<%=request.getContextPath() %>/test/shiroTest.do"  title="权限测试">权限测试</a></li>
